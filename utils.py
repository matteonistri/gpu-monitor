...
#can be removed... attack files exists...
...
def executeTest(IMAGESET, x_test_set, classifier,repeat):
    ...
    print("Just a sleep of {}, before moving to the next attack".format(SLEEP))
...
def executeAll(IMAGESET, x_test_adv, classifier,CLASS, ATTACK, LEARNER, y_test, itemN,REPETITION,LOGACCURACY):
    ...
    print("Accuracy on test set of {} under attack {}: {}%\n".format(IMAGESET, ATTACK, accuracy * 100))
